# -*- test-case-name: higgins.http.test.test_httpauth -*-
...
from higgins.http import http
from higgins.http import iweb
from higgins.http.auth.interfaces import IAuthenticatedRequest
...
class HTTPAuthResource(object):
    ...
    def __init__(self, wrappedResource, credentialFactories,
                 portal, interfaces):
        """
        @param wrappedResource: A L{higgins.http.iweb.IResource} to be returned
