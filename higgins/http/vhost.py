# -*- test-case-name: higgins.http.test.test_vhost -*-
...
class NameVirtualHost(resource.Resource):
    ...
    def __init__(self, default=None):
        ...
        @param default: The default resource to be served when encountering an
            unknown hostname.
        @type default: L{higgins.http.iweb.IResource} or C{None}
        """
    ...
    def addHost(self, name, resrc):
        ...
        @param resrc: The L{higgins.http.iweb.IResource} to be served as the
            given hostname.
